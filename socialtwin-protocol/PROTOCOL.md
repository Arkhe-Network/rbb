...
Wire formats for the SocialTwin twin/JWT system on RBB. Source of truth is the contracts; this documents what an integrator must reproduce. Chain: RBB mainnet (`12120014`). Live addresses: [`README.md`](./README.md).
