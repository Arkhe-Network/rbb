...
pub async fn handle_get_context(
    ...
    Ok(json!({
        ...
        "metadata": {
            ...
            "total_tokens": metadata.total_tokens,
            "compression_ratio": metadata.compression_ratio,
            "oldest_entry": metadata.oldest_entry.map(|d: chrono::DateTime<chrono::Utc>| d.to_rfc3339()),
            "newest_entry": metadata.newest_entry.map(|d: chrono::DateTime<chrono::Utc>| d.to_rfc3339()),
        },
