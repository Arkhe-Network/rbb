...
contract BTFSProviderRegistry {
    ...
    // Simplification for onlyThreshold
    address public governanceThreshold;

    constructor(address _governanceThreshold) {
        governanceThreshold = _governanceThreshold;
    }

    modifier onlyThreshold() {
        require(msg.sender == governanceThreshold, "Not threshold");
        _;
    }
