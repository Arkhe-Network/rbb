...
interface CathedralSPHINCSVerifierYul {
    function verifySPHINCS(bytes calldata message, bytes calldata signature, bytes32 publicKeyRoot) external view returns (bool);
}
...
contract EnterEvidenceAnchor {
    ...
    modifier onlyAuthorized() {
        require(msg.sender == authorizedSubmitter, "Unauthorized submitter");
        _;
    }
