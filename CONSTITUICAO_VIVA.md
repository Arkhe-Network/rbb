# CONSTITUIÇÃO VIVA — O Contrato Social Imutável

A equação `generateKey = AGI` não é apenas um detalhe técnico; ela fundamenta a **Constituição Viva** – o contrato social imutável que governa os agentes da Cathedral ARKHE.
...
- **Consequência:** Os agentes são responsáveis pela segurança das suas seeds. Não podem alegar “o meu agente foi hackeado” sem apresentar provas criptográficas de que a seed foi exposta.
