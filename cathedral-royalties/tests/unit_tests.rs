use cathedral_royalties::integrations::pix::{PixGateway, PixPaymentRequest, PixStatus};
use cathedral_royalties::integrations::picnic::PicnicRoyaltyManager;
use cathedral_royalties::evolution::desci_node_resource::{RoyaltySplit, RoyaltyConfig, FreeTier};
use cathedral_royalties::integrations::pix_openapi::PixWebhookPayload;
use serde_json::json;
...
mod tests {
    ...
    fn test_webhook_payload_deserialization() {
        ...
        // We'll skip exact enum equality to save imports since we are testing JSON structure here.
