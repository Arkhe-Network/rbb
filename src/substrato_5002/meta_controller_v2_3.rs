...
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(Default)]
pub enum TrainingPhase { #[default] Warmup, ActiveLearning, PlateauDetected, RsiInProgress, Evaluation, Cooldown }
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(Default)]
pub enum RsiStatus { #[default] Idle, Triggered { reason: RsiReason, component: String }, Validating { proposal: RsiProposalV2 }, Deploying { proposal: RsiProposalV2 }, Completed { proposal: RsiProposalV2, improvement: f64 }, Failed { error: String } }
...
pub struct RsiProposalV2 { pub component: String, pub original_code: String, pub proposed_code: String, pub wasm_code: Vec<u8>, pub code_hash: [u8; 32], pub depth: u32, pub domain: RestrictedDomain, pub test_cases_passed: usize, pub sandbox_metrics: SandboxMetrics, pub compile_time_ms: u64, pub binary_size_bytes: usize, pub rustc_version: String, pub timestamp: i64 }
#[derive(Debug, Clone, Default)] #[derive(serde::Deserialize)]
#[derive(serde::Serialize)]
pub struct SandboxMetrics { pub fuel: u64, pub memory: usize, pub time_ms: u64 }
#[derive(Debug, Clone, PartialEq)] #[derive(serde::Deserialize)]
#[derive(serde::Serialize)]
pub enum RestrictedDomain { MathematicalReasoning, AlgorithmicProblemSolving, FormalLogic, StructuredComposition }
...
#[derive(Debug, Clone)] #[derive(serde::Serialize, serde::Deserialize)]
pub struct ValidatedRsiProposal { pub overall_verdict: Verdict, pub gate_results: Vec<(ProteusGate, GateResult)> }
#[derive(Debug, Clone, PartialEq)] #[derive(serde::Serialize, serde::Deserialize)]
pub enum Verdict { Promote, Kill, Defer, Watch }
#[derive(Debug, Clone, PartialEq)] #[derive(serde::Serialize, serde::Deserialize)]
pub enum ProteusGate { RootCauseInTarget, RealisticAttackerInput, ConcreteSecurityImpact, DefaultConfiguration, NegativeControlsPass, NoDuplicates, PublicIntelComplete, TimelineUnderstood, SkepticRefutationAttempted, ExceptionalImpactOrKilled, RealisticPoC }
#[derive(Debug, Clone, PartialEq)] #[derive(serde::Serialize, serde::Deserialize)]
pub enum GateResult { Pass { evidence: String }, Fail { reason: String, evidence: String }, Blocked { reason: String }, NotApplicable { reason: String } }
...
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(PartialEq)]
pub struct HierarchyLevel { pub level: u8, pub title: String, pub content_template: String }
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(PartialEq)]
pub struct FewShotExample { pub input: String, pub reasoning: String, pub output: String, pub tags: Vec<String> }
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(PartialEq)]
pub struct AnalogyMapping { pub source_concept: String, pub target_concept: String, pub explanation: String }
