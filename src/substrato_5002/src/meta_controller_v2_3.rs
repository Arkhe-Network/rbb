...
pub enum CognitiveTaskType { Planning, CodeGeneration, SecurityAudit, GovernanceReview, DataAnalysis, ToolExecution, Reflection, Custom(String) }
...
impl MetaControllerV23 {
    ...
    async fn validate_pre_rsi_with_prompt(&self, component: &str, _prompt: &GeneratedPrompt) -> Result<ValidatedRsiProposal, MetaError> {
...
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(Default)] pub enum TrainingPhase { #[default] Warmup, ActiveLearning, PlateauDetected, RsiInProgress, Evaluation, Cooldown }
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(Default)] pub enum RsiStatus { #[default] Idle, Triggered { reason: RsiReason, component: String }, Validating { proposal: RsiProposalV2 }, Deploying { proposal: RsiProposalV2 }, Completed { proposal: RsiProposalV2, improvement: f64 }, Failed { error: String } }
...
#[derive(Debug, Clone, Serialize, Deserialize)] pub struct RsiProposalV2 { pub component: String, pub original_code: String, pub proposed_code: String, pub wasm_code: Vec<u8>, pub code_hash: [u8; 32], pub depth: u32, pub domain: RestrictedDomain, pub test_cases_passed: usize, pub sandbox_metrics: SandboxMetrics, pub compile_time_ms: u64, pub binary_size_bytes: usize, pub rustc_version: String, pub timestamp: i64 }
#[derive(Debug, Clone, Default, Serialize, Deserialize)] pub struct SandboxMetrics { pub fuel: u64, pub memory: usize, pub time_ms: u64 }
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)] pub enum RestrictedDomain { MathematicalReasoning, AlgorithmicProblemSolving, FormalLogic, StructuredComposition }
#[derive(Debug, Clone, Serialize, Deserialize)] pub struct Skill { pub id: String, pub name: String, pub domain: RestrictedDomain, pub wasm_code: Vec<u8>, pub code_hash: [u8; 32], pub performance: SkillPerformance, pub dependencies: Vec<String>, pub version: u32, pub provenance: Provenance, pub created_at: i64, pub last_used_at: i64, pub use_count: u64 }
#[derive(Debug, Clone, Serialize, Deserialize)] pub struct SkillPerformance { pub accuracy: f64, pub avg_execution_time_ms: u64, pub avg_fuel_consumed: u64, pub success_rate: f64, pub composite_score: f64 }
#[derive(Debug, Clone, Serialize, Deserialize)] pub struct Provenance { pub rsi_proposal_id: String, pub godel_agent_depth: u32, pub epoch_created: u64, pub lyapunov_v_at_creation: f64 }
...
#[derive(Debug, Clone, Serialize, Deserialize)] pub struct ValidatedRsiProposal { pub overall_verdict: Verdict, pub gate_results: Vec<(ProteusGate, GateResult)> }
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)] pub enum Verdict { Promote, Kill, Defer, Watch }
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)] pub enum ProteusGate { RootCauseInTarget, RealisticAttackerInput, ConcreteSecurityImpact, DefaultConfiguration, NegativeControlsPass, NoDuplicates, PublicIntelComplete, TimelineUnderstood, SkepticRefutationAttempted, ExceptionalImpactOrKilled, RealisticPoC }
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)] pub enum GateResult { Pass { evidence: String }, Fail { reason: String, evidence: String }, Blocked { reason: String }, NotApplicable { reason: String } }
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)] pub enum ProposalType { ArchitectureModification, HyperparameterChange, CodeModification, MemoryStructureChange, NewSkill }
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)] pub enum ProteusFront { Argus, Loom, Chaos, Libris, Mimic, Artificer, Skeptic, Cicada }
...
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(PartialEq)] pub struct HierarchyLevel { pub level: u8, pub title: String, pub content_template: String }
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(PartialEq)] pub struct FewShotExample { pub input: String, pub reasoning: String, pub output: String, pub tags: Vec<String> }
#[derive(Debug, Clone, Serialize, Deserialize)] #[derive(PartialEq)] pub struct AnalogyMapping { pub source_concept: String, pub target_concept: String, pub explanation: String }
