...
impl FingerprintRegistry {
    ...
    pub fn check_near_duplicate(
        ...
        let is_duplicate = similar_count >= 1;

        if !is_duplicate || similar_count < self.duplicate_threshold {
...
impl TimingCorrelationEngine {
    pub fn new(window_ms: u64, threshold: u32) -> Self {
        Self {
            ...
            window_ms,
            _correlation_threshold: threshold,
        }
    }
