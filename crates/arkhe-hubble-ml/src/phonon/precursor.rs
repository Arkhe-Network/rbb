...
mod tests {
    ...
    fn test_action_mapping() {
        ...
        assert_eq!(PrecursorAction::from_strength(0.5), PrecursorAction::IncreaseSampling);
        assert_eq!(PrecursorAction::from_strength(1.5), PrecursorAction::PreactivateInference);
        assert_eq!(PrecursorAction::from_strength(3.0), PrecursorAction::ActivateInference);
