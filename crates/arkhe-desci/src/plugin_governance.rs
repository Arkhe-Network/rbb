use arkhe_governance::invariants::GovernanceInvariantChecker;
...
pub struct PluginValidator {
    engine: GovernanceInvariantChecker,
...
impl Default for PluginValidator {
    fn default() -> Self {
        Self {
            engine: GovernanceInvariantChecker::default(),
...
impl PluginValidator {
    ...
    pub fn validate(&self, manifest: &PluginManifest) -> Result<ValidationResult, DesciError> {
        ...
        let source_check = if !self.allowed_sources.is_empty() {
            ...
            ValidationCheck {
                invariant_id: "CNT-003".to_string(),
                passed: true,
                message: "No source restrictions".to_string(),
            }
        };
