...
impl NonologyTerm {
    ...
    pub fn is_transcendental(&self) -> bool { matches!(self, NonologyTerm::PromptOntology) }
}
...
pub struct Transcendental { __ground: (), terms: [NonologyTerm; 11] }
impl Transcendental {
    pub fn new() -> Self {
        Self {
            __ground: (),
            terms: [
                NonologyTerm::PromptLoop, NonologyTerm::ContextualLoop, NonologyTerm::ContextLoop,
                NonologyTerm::PromptTemplate, NonologyTerm::CognitiveLoop, NonologyTerm::OntologicLoop,
                NonologyTerm::LoopOntology, NonologyTerm::OntologyPrompt, NonologyTerm::PromptOntologic,
                NonologyTerm::OntologicPrompt, NonologyTerm::PromptOntology
            ]
        }
    }
    pub fn indicate(&self) -> &'static str { "The ground is not a loop." }
    pub fn terms(&self) -> &[NonologyTerm; 11] { &self.terms }
}
