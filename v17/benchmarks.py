...
def benchmark_memory():
    ...
    if not mem.available:
        print("  ❌ hnswlib não disponível, pulando benchmark de memória")
        print()
        return
...
if __name__ == "__main__":
    # We may not have torch or psutil installed, so wrap around
    try:
        print_hardware_info()
    except ImportError:
        print("  (Torch/psutil not installed, skipping hardware info)")
